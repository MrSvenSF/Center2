...
/**
 * Reads the configuration files MHCenter2 uses on Velocity.
 *
...
public final class VelocityConfigLoader {
    ...
    /**
     * Loads everything MHCenter2 needs on the proxy.
     *
     * @param dataDirectory data folder of MHCenter2 on the proxy
