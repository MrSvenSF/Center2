...
/**
 * The administrative permissions of MHCenter2 on the proxy.
 *
 * <p>Velocity has no {@code Permissions.yml}: the proxy side of MHCenter2 brings no
...
public final class ProxyPermissions {
    ...
    /** Master permission for every MHCenter2 admin function. */
