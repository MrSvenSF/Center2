...
/**
 * The module administration of MHCenter2 on the proxy.
 *
...
public final class VelocityModuleService implements ModuleAdministration.Modules {
     ...
     *
     * @param commands the command service of MHCenter2 on the proxy
     */
     ...
     *
     * @param dataDirectory the MHCenter2 folder of the proxy
