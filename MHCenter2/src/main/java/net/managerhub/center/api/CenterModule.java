...
/**
 * The contract every MHCenter2 module implements.
 *
 ...
 *
 * <p>MHCenter2 calls the lifecycle methods in this order and never in parallel:
...
public interface CenterModule {
    ...
    /**
     * Tells the module that the configuration of MHCenter2 was reloaded.
     *
     * <p>MHCenter2 calls this on every running module when an administrator uses
     ...
     * stopped, because MHCenter2 cannot know what part of its configuration was
     * applied.</p>
     *
    ...
    /**
     * Stops the module again. MHCenter2 calls this once for every module that was
