...
/**
 * Paper entry point of MHCenter2.
 *
...
public final class CenterPaperPlugin extends JavaPlugin {
    ...
    /** Namespace of the {@code namespace:command} form of every MHCenter2 command. */
    private static final String COMMAND_NAMESPACE = "mhcenter2";
