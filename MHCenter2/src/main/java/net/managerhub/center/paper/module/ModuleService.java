...
/**
 * The module administration of MHCenter2 on Paper.
 *
...
public final class ModuleService implements ModuleAdminAction, ModuleAdministration.Modules {
     ...
     * was built.
     *
     * @param commands the command registration of MHCenter2
     ...
     *
     * @param dataFolder the MHCenter2 folder of this server
