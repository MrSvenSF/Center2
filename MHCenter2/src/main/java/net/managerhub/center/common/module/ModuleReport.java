...
public interface ModuleReport {
    ...
    /**
     * A jar below {@code Modules/Jars} that is not a usable MHCenter2 module at all.
     *
    ...
    /**
     * A module that does not support the running MHCenter2 version.
     *
     * @param module  metadata of the module
     * @param running the running MHCenter2 version
     */
     ...
     *
     * @param directory the folder MHCenter2 tried to read
     ...
     *
     * <p>MHCenter2 does not know which modules an administrator switched off, so no
