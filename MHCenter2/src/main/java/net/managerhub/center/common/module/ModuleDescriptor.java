 ...
 *
 * <p>Every module names the MHCenter2 versions it supports. A module that runs on
 ...
 * @param centerVersions    the MHCenter2 versions the module supports
...
public record ModuleDescriptor(String id,
    ...
    /** Metadata entry with the oldest supported MHCenter2 version. */
    public static final String CENTER_MIN_VERSION = "center-min-version";

    /** Metadata entry with the newest supported MHCenter2 version. */
    ...
    /**
     * @param running the platform MHCenter2 is running on
     ...
     * @return {@code true} if this module supports that MHCenter2 version
     */
