 ...
 * means MHCenter2 never opens a connection at all - it does not even try, so a
 ...
 * keeps MHCenter2 running locally with the remote system switched off. That is on
