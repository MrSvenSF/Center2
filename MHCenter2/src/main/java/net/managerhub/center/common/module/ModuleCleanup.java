...
/**
 * The cleanup actions one module handed to MHCenter2.
 *
 * <p>MHCenter2 cannot remove what it does not know about. A module that registers a
 * listener, a task or any other resource therefore says right away how it is
 * removed again, and MHCenter2 runs those actions when the module is stopped, when
