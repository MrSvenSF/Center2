...
/**
 * One MHCenter2 node as the remote database knows it.
 *
 * <p>A node writes this row every heartbeat interval. It is deliberately small:
 * who am I, what am I, when was I last alive. MHCenter2 is not a monitoring
 * system.</p>
 *
 ...
 * @param centerVersion    the MHCenter2 version running there
