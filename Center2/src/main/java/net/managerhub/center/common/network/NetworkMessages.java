 ...
 * limit of this way and the reason Center2 never claims that a server was
...
public final class NetworkMessages {
    ...
    public static final String CHANNEL_NAMESPACE = "center2";
    ...
    /** Paper tells the proxy that Center2 is running on this server. */
    ...
    /** Paper asks the proxy to reload the whole Center2 network. */
    public static final String RELOAD_REQUEST = "RELOAD_REQUEST";

    /** The proxy tells one Paper server to reload its own Center2. */
