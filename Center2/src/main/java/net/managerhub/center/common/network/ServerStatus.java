...
/**
 * State of one instance in the Center2 network.
 *
 * <p>A server that was never verified is {@link #UNKNOWN}. That is not the same
 * as "Center2 is missing there": it only means that Center2 has not seen a
 * handshake from that server yet.</p>
 */
public enum ServerStatus {

    /** The server answers and Center2 was verified there. */
    CONNECTED,

    /** The server does not answer at the moment. */
    UNREACHABLE,

    /** The server answers, but Center2 was not verified there yet. */
    UNKNOWN;
