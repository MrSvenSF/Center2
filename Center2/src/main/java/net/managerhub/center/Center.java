...
/**
 * Fixed product constants of Center2.
 *
...
public final class Center {
    ...
    /** Visible product name. Always "Center2". */
    public static final String PRODUCT_NAME = "Center2";

    /** Product version. */
    public static final String VERSION = "1.0.0-beta.1";

    /** Organization behind Center2. */
    ...
    /** Configuration version every Center2 YAML file must declare. */
