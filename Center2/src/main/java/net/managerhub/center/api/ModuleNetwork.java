...
/**
 * What one module may do in the Center2 network.
 *
 * <p>Center2 prefers the optional remote database and falls back to player-carried
 ...
 * what happens there is decided by that module, in its own code. Center2 never
...
public interface ModuleNetwork {
     ...
     *
     * @return the id of this Center2 node, or an empty text
     */
    String serverId();

    /**
     * @return the ids of every Center2 node that sent a heartbeat recently, this
     ...
     * Center2 removes the listener again when the module is stopped, so a module
