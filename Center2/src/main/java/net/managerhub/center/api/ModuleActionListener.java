 ...
 *
 * <p>Center2 calls this off the main server thread and off the event loop of the
...
public interface ModuleActionListener {
     ...
     * @throws Exception if the action could not be carried out; Center2 writes the
