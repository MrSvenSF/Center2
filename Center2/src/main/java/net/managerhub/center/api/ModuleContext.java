...
/**
 * Everything a Center2 module gets from the core.
 *
 ...
 * a Paper class through its Center2 API, and the other way round.</p>
 */
public interface ModuleContext {
     ...
     *
     * <p>Center2 never creates files there. A module that needs a configuration
     ...
     *
     * @return the platform Center2 is running on
     */
    ModulePlatform platform();

    /**
     * Hands Center2 an action that removes one resource of this module again.
     *
     * <p>Center2 only knows about the things it hands out itself. Everything a
     * module registers on its own - a listener, a scheduled task, an open file, a
     * thread - is removed by exactly this action. Center2 runs it when the module
     ...
     * same notation the command configuration of Center2 uses. The first segment
     ...
     * the Center2 command tree from now on. It is refused when the path is
     * invalid, when it belongs to a Center2 core command or one of its aliases,
     ...
     *
     * <p>Center2 removes the command again when the module is stopped or fails,
    ...
    /**
     * What this module may do in the Center2 network.
     *
     ...
     * part of the API. On the proxy Center2 offers
