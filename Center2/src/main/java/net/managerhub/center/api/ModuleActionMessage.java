 ...
 *
 * <p>The action was written by the same module on another Center2 node. Center2
 ...
 * and Center2 will never execute it as one.</p>
 *
 ...
 * @param payload  the data of the module, never interpreted by Center2
 */
