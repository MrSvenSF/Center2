 ...
 * cleanup and command registration. Nothing of the internal Center2
...
public final class PaperModuleSupport implements ModuleLoader.ContextFactory {
    ...
    /**
     * @param plugin   the Center2 plugin, used for the log
    ...
    private record Context(ModuleDescriptor descriptor,
         ...
         * Bukkit API on its class path and needs nothing from Center2 for it.
         */
        @Override
